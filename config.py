...
screens = [
    Screen(
        top=bar.Bar(
            [
                widget.Image(
                    filename="/home/zamyaza/.config/qtile/arch.png",
                    background = dracula_negro
                    ),
                widget.GroupBox(
                    background=dracula_negro,
                    highlight_method='line',
                    inactive=dracula_gris,
                    highlight_color = [dracula_negro, dracula_negro],
                    active = dracula_blanco
                    ),
                widget.TextBox(
                    text='',
                    font="JetBrainsMonoMedium Nerd Font Mono",
                    background=dracula_gris,
                    foreground=dracula_negro,
                    padding=0,
                    fontsize=30,
                    ),
                widget.Chord(
                    chords_colors={
                        "launch": (dracula_gris, "#ffffff"),
                    },
